...
/* package Znanstveni-kalkulator-0.1.0.0 */
#ifndef VERSION_Znanstveni_kalkulator
#define VERSION_Znanstveni_kalkulator "0.1.0.0"
#endif /* VERSION_Znanstveni_kalkulator */
#ifndef MIN_VERSION_Znanstveni_kalkulator
#define MIN_VERSION_Znanstveni_kalkulator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Znanstveni_kalkulator */
...
#define CURRENT_COMPONENT_ID "Znanstveni-kalkulator-0.1.0.0-inplace-Znanstveni-kalkulator"
